...
<div class="container flex items-center py-56">
    @if (Route::has('login'))
    <section id="left" class="w-1/2">
        <img src="{{ asset('img/svg/maintenance.svg') }}" width="80%" class="mx-auto">
    </section>
    <section id="right" class="w-1/2 text-center">
        <div id="explain">
        ...
        @auth
        <div id="home"
            class="w-1/2 px-4 py-2 mx-auto bg-indigo-500 hover:bg-indigo-600 text-white transition hover:text-white hover:no-underline rounded-lg">
        ...
        <div class="mb-2">
            <a href="{{ route('login') }}" class=" hover:text-white hover:no-underline">
                <button id="login"
                    class="w-1/2 px-4 py-2 mx-auto bg-indigo-500 hover:bg-indigo-600 text-white transition rounded-lg">
                    ログイン
                </button>
            </a>
        </div>
